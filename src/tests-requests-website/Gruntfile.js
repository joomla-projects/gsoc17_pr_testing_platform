...
module.exports = function(grunt) {
    ...
    grunt.initConfig({
        bower: {
            dev: {
                dest: 'htdocs/media/js/vendor',
                css_dest: 'htdocs/media/css/vendor',
                options: {
                    expand: true,
                    packageSpecific: {
                        'bootstrap': {
                        ...
                        'blueimp-file-upload': {
                            images_dest: 'htdocs/media/css/vendor',
                            files: [
                        ...
                        'octicons': {
                            fonts_dest: 'htdocs/media/css/vendor',
                            files: [
        ...
        bower_concat: {
            all: {
                ...
                dest: 'htdocs/media/js/vendor.js',
                cssDest: 'htdocs/media/css/vendor.css',
                mainFiles: {
        ...
        cssmin: {
            target: {
                files: {
                    'htdocs/media/css/vendor.min.css': 'htdocs/media/css/vendor.css'
                }
            }
        },
        uglify: {
            bower: {
                files: {
                    'htdocs/media/js/vendor.min.js': 'htdocs/media/js/vendor.js'
                }
            },
            core: {
                files: {
                    'htdocs/media/js/jtracker.min.js': 'htdocs/media/js/jtracker.js'
                }
            }
        },
        replace: {
            dist: {
                src: 'htdocs/media/css/vendor.css',
                overwrite: true,
                replacements: [
