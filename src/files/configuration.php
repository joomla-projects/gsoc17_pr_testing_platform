...
class JConfig
{
	...
	public $password = '${DBPASSWORD}';      // DB password
	public $db = '${DBNAME}';                // DB database name
	...
	public $ftp_root = '';
	public $ftp_enable = '0';
	public $tmp_path = '/shared/httpd/${INSTANCEFOLDER}/htdocs/administrator/logs';
	public $log_path = '/shared/httpd/${INSTANCEFOLDER}/htdocs/tmp';
	...
	public $mailonline = '1';
	public $mailer      = 'mail';
	public $mailfrom    = 'email@example.com';
